                ...
                <v-row class="mt-4 mb-8">
                    <v-col cols="12" md="6">
                        ...
                        <v-card class="mt-4">
                            ...
                            <v-card-text>
                                <v-radio-group v-model="form.marketType" row>
                                    <v-radio label="On Market" value="onmarket"></v-radio>
                                    <v-radio label="Off Market" value="offmarket"></v-radio>
                                </v-radio-group>
                            </v-card-text>
                        </v-card>
                        <v-card class="mt-4">
...
<!--                                                ></v-select>-->
            ...
            <v-dialog
                v-model="showAvailableTypeDialog"
                width="500"
                persistent
            >
                <v-card>
                    ...
                    <v-card-text>
                        <p class="mt-6 font-size-regular">
                            I hereby confirm that this offer is not being traded in parallel on the public market. It is 100% an off-market offer that is not visible on the known platforms.<br/>
                            <br/>
                            If it is, our team will place it in the category "On-Market" and you will receive a warning (Red Flag). If you receive more than one warning, you will be redirected from that platform. Please answer:
                        </p>
                        <v-radio-group v-model="form.availableType">
                            <v-radio
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <p class="font-size-regular">
                            After a review, which usually takes 24 hours, we will release your offer. Just to be save:
                        </p>
                        <v-radio-group v-model="form.publishType">
                            <v-radio
        ...
        data() {
            return {
                ...
                availableTypes: [
                    ...
                    {
                        value: 'nonpublic',
                        label: 'I have also given the offer to other brokers, but they do not offer it publicly',
                    },
                    {
                        value: 'public',
